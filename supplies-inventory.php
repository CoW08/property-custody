...
const HISTORICAL_INVENTORY_ITEMS = [
    ...
    { item_code: 'CLN-GAUZE', name: 'Gauze Pads', category: 'clinic', unit: 'boxes', default_stock: 50, minimum_stock: 10, location: 'Clinic Storage', unit_cost: 120, description: 'Sterile gauze pads for wound dressing.' },
    { item_code: 'CLN-TAPE', name: 'Medical Tape', category: 'clinic', unit: 'rolls', default_stock: 40, minimum_stock: 10, location: 'Clinic Storage', unit_cost: 80, description: 'Adhesive medical tape for securing dressings.' },
