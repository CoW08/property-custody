                ...
                <div class="flex flex-wrap items-center gap-3 sm:gap-4">
                    <?php if ($isCustodian): ?>
                        <div class="flex items-center gap-2">
                            <label for="departmentFilter" class="text-sm font-medium text-gray-600 whitespace-nowrap">Department:</label>
                            <select id="departmentFilter" class="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
